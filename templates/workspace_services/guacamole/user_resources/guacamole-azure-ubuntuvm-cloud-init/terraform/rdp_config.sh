...
echo "deb [trusted=yes] $NEXUS_URL/repository/ubuntu-proxy-repo bionic main restricted universe multiverse" >>
echo "deb [trusted=yes] $NEXUS_URL/repository/ubuntu-proxy-repo bionic-updates main restricted universe multiverse" >>
