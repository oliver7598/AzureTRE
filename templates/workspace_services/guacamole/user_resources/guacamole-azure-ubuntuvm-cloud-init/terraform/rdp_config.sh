...
echo "deb [trusted=yes] $NEXUS_URL/repository/ubuntu-proxy-repo bionic main restricted" >>
...
echo "deb [trusted=yes] $NEXUS_URL/repository/ubuntu-packages-proxy-repo bionic main restricted" >> /etc/apt/sources.list
echo "deb [trusted=yes] $NEXUS_URL/repository/ubuntu-packages-proxy-repo bionic universe" >> /etc/apt/sources.list
echo "deb [trusted=yes] $NEXUS_URL/repository/ubuntu-packages-proxy-repo bionic multiverse" >> /etc/apt/sources.list
